...
RegisterNetEvent('rsg-radialmenu:client:SendMedicEmergencyAlert', function()
    ...
    local lastname = Player.charinfo.lastname
    -- notify medics
    TriggerServerEvent('rsg-medic:server:medicAlert', 'Медик '..firstname..' '..lastname..' изпрати спешна сова!')
    -- notify police
    TriggerServerEvent('police:server:policeAlert', 'Медик '..firstname..' '..lastname..' изпрати спешна сова!')
end)
